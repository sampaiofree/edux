...
<body style="margin:0;padding:24px;background:#f8fafc;font-family:Arial,sans-serif;color:#0f172a;">
    <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:16px;padding:32px;border:1px solid #e2e8f0;">
        <p style="margin:0 0 8px;font-size:12px;letter-spacing:.08em;text-transform:uppercase;color:#2563eb;">Criar conta</p>
        <h1 style="margin:0 0 16px;font-size:28px;line-height:1.2;color:#1d4ed8;">Seu código chegou</h1>

        <p style="margin:0 0 16px;font-size:16px;line-height:1.6;">
            Use este código para ativar sua conta na plataforma {{ $schoolName }}.
        </p>
        ...
        <p style="margin:0;font-size:14px;line-height:1.6;color:#64748b;">
            Se você não pediu a criação desta conta, pode ignorar este e-mail.
        </p>
    </div>
</body>
</html>

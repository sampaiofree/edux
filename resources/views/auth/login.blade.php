            ...
            >
                ...
                >
                    <div class="mx-auto max-w-md space-y-6">
                        ...
                        <div class="space-y-3">
                            <h2 class="font-display text-3xl leading-tight text-slate-900">Baixe nosso aplicativo</h2>
                            <p class="text-sm leading-6 text-slate-600 sm:text-base">
                                Para entrar na sua conta, use o aplicativo Portal JE. Baixe o app na loja do seu celular e faça login por lá.
                            </p>
                        </div>
